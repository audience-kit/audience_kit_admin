...
export type AppCurrentUserQuery$variables = Record<PropertyKey, never>;
export type AppCurrentUserQuery$data = {
  readonly me: {
...
export type AppCurrentUserQuery = {
  response: AppCurrentUserQuery$data;
  variables: AppCurrentUserQuery$variables;
};
...
(node as any).hash = "2dec0b5a73b3d4eba672707ae5dc2dd6";
